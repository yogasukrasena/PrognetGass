        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="{{ Route::currentRouteNamed('admin.showProduct', 'admin.KPdetail', 'admin.FotoD', 'inProduct.index', 'inProduct.edit') ? 'active' : '' }}">
                        <a href="{{ route('admin.showProduct') }}">  <i class="menu-icon fa fa-laptop"></i>Produk</a>
                    </li>
