...
<body>
	  ...
	  <div class="container mt-5">
		<div class="row">
		  <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            @foreach ($editU as $data)
			<div class="login-brand">
			  <img src="{{ asset('images/fotoProfileUsers/'.$data->profile_image) }}" alt="logo" width="300" class="shadow-light rounded-circle">
			</div>
			  ...
			  <div class="card-body">
                <form action="{{ route('pelanggan.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input id="name" type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" autofocus value="{{ $data->name }}">
                      @if ($errors->has('name'))
  ...
  <!-- JS Libraies -->
  <script src="{{ asset('form/node_modules/jquery-pwstrength/jquery.pwstrength.min.js') }}"></script>
  <script src="{{ asset('form/node_modules/selectric/public/jquery.selectric.min.js') }}"></script>
  ...
  <script src="{{ asset('form/assets/js/page/auth-register.js') }}"></script>
</body>
</html>
