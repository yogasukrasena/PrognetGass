							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
										<img src="{{ asset('images/fotoProduct/'.$data->image_name) }}" alt="IMG-PRODUCT" height="200" width="150">
									...
									<div class="block2-txt p-t-20">
										<a href="{{ route('user.show', $data->id) }}" class="block2-name dis-block s-text3 p-b-5">
											{{ $data->product_name }}
										</a>
